...
def level_1_music():
    pygame.mixer.music.stop()
    pygame.mixer.music.load("music-n-stuff/First_level.ogg")
    pygame.mixer.music.play(-1)

def level_2_music():
    pygame.mixer.music.stop()
    pygame.mixer.music.load("music-n-stuff/Second_level.ogg")
    pygame.mixer.music.play(-1)

def level_3_music():
    pygame.mixer.music.stop()
    pygame.mixer.music.load("music-n-stuff/Third_level.ogg")
    pygame.mixer.music.play(-1)

def level_4_music():
    pygame.mixer.music.stop()
    pygame.mixer.music.load("music-n-stuff/Space_level.ogg")
    pygame.mixer.music.play(-1)

    
def main_menu():
    pygame.mixer.music.stop()
    pygame.mixer.music.load("music-n-stuff/Main_menu.ogg")
    pygame.mixer.music.play(-1)

def win_music():
    pygame.mixer.music.stop()
    pygame.mixer.music.load("music-n-stuff/End_sound.ogg")
    pygame.mixer.music.play(-1)
...
# Fonts
font_xs = load_font("assets/fonts/The_Curious_Cat.ttf", 16)
font_sm = load_font("assets/fonts/The_Curious_Cat.ttf", 32)
font_md = load_font("assets/fonts/The_Curious_Cat.ttf", 48)
font_lg = load_font("assets/fonts/The_Curious_Cat.ttf", 64)
font_xl = load_font("assets/fonts/The_Curious_Cat.ttf", 80)


# Sounds
jump_snd = load_sound('assets/sounds/jump.ogg')
gem_snd = load_sound('assets/sounds/gem.ogg')
intersect_snd = load_sound('assets/sounds/cat.ogg')
game_over_snd = load_sound('assets/sounds/game_over.ogg')

# Music


# Images
idle = load_image('assets/images/characters/hero/cat.png')
walk = [load_image('assets/images/characters/hero/cat_walk_1.png'),
        load_image('assets/images/characters/hero/cat_walk_2.png')]
jump = load_image('assets/images/characters/hero/cat_jump.png')
hurt = load_image('assets/images/characters/hero/cat_hurt.png')

fall = load_image('assets/images/characters/hero/cat_fall.png')
...
start_image = load_image('assets/images/tiles/splash_screen.png')

idle_dog1 = load_image('assets/images/characters/enemy/dog.png')
idle_dog2 = load_image('assets/images/characters/enemy/dog_2.png')


tile_images = { "Grass": load_image('assets/Absract_Platformer/PNG/Tiles/grass/tileYellow_06.png'),
                "Grass_curve1": load_image('assets/Absract_Platformer/PNG/Tiles/grass/tileYellow_07.png'),
                "Grass_curve2": load_image('assets/Absract_Platformer/PNG/Tiles/grass/tileYellow_05.png'),
                                "Grass_single": load_image('assets/Absract_Platformer/PNG/Tiles/grass/tileYellow_08.png'),
                "Dirt": load_image('assets/Absract_Platformer/PNG/Tiles/grass/tileYellow_09.png'),
                ...
                "Pine_tree":load_image('assets/background_element/PNG/Default/treePine.png'),
                "Snow": load_image('assets/Absract_Platformer/PNG/Tiles/snow/tileBlue_05.png'),
                "Snow_curve2": load_image('assets/Absract_Platformer/PNG/Tiles/snow/tileBlue_04.png'),
                "Snow_curve1": load_image('assets/Absract_Platformer/PNG/Tiles/snow/tileBlue_06.png'),
                "Snow_single":load_image('assets/Absract_Platformer/PNG/Tiles/snow/tileBlue_07.png'),
                "Snow_dirt": load_image('assets/Absract_Platformer/PNG/Tiles/snow/tileBlue_08.png'),
                "Snow_pine": load_image('assets/background_element/PNG/Default/treePineSnow.png'),
                "Frozen_pine":load_image('assets/background_element/PNG/Default/treePineFrozen.png'),
                "Sand":load_image('assets/Absract_Platformer/PNG/Tiles/Desert/tileBrown_02.png'),
                "Sand_curve2": load_image('assets/Absract_Platformer/PNG/Tiles/Desert/tileBrown_01.png'),
                "Sand_curve1": load_image('assets/Absract_Platformer/PNG/Tiles/Desert/tileBrown_03.png'),
                "Sand_single":  load_image('assets/Absract_Platformer/PNG/Tiles/Desert/tileBrown_04.png'),
                "Sand_dirt":  load_image('assets/Absract_Platformer/PNG/Tiles/Desert/tileBrown_09.png'),
                "Dead_tree": load_image('assets/background_element/PNG/Default/treeDead.png'),
                "Desert_pine":load_image('assets/background_element/PNG/Default/treePineOrange.png'),
                "Planet":load_image('assets/Absract_Platformer/PNG/Tiles/Space/tileGreen_05.png'),
                "Planet_curve2": load_image('assets/Absract_Platformer/PNG/Tiles/Space/tileGreen_04.png'),
                "Planet_curve1": load_image('assets/Absract_Platformer/PNG/Tiles/Space/tileGreen_06.png'),
                "Planet_single":load_image('assets/Absract_Platformer/PNG/Tiles/Space/tileGreen_07.png'),
                "Planet_dirt": load_image('assets/Absract_Platformer/PNG/Tiles/Space/tileGreen_08.png'),
                "Missle": load_image('assets/images/items/spaceMissiles_3.png'),
                "Snowman":load_image('assets/images/items/snowman.png'),
                "Cactus": load_image('assets/images/items/cactus.png')
                }
     
basic_enemy_walk = [ load_image('assets/images/characters/enemy/dog_walk_1.png'),
                       load_image('assets/images/characters/enemy/dog_walk_2.png') ]

basic_enemy_fall = load_image('assets/images/characters/enemy/dog_fall.png')

basic_enemy_images = { "walk_rt": basic_enemy_walk,
                       "walk_lt": [flip_image(img) for img in basic_enemy_walk],
                       "fall_rt": basic_enemy_fall,
                       "fall_lt": flip_image(basic_enemy_fall)}


platform_enemy_walk = [ load_image('assets/images/characters/enemy/dog_2_walk_1.png'),
                          load_image('assets/images/characters/enemy/dog_2_walk_2.png') ]

platform_enemy_images = {"walk_rt": platform_enemy_walk,
                         "walk_lt": [flip_image(img) for img in platform_enemy_walk]
                                     }

item_images = { "Fish": load_image('assets/Fish/PNG/Default_size/fishTile_078_1.png'),
                "Cold_Fish": load_image('assets/Fish/PNG/Default_size/fishTile_076.png'),
                "Desert_Fish": load_image('assets/Fish/PNG/Default_size/fishTile_095.png'),
                "Alien_Fish": load_image('assets/Fish/PNG/Default_size/fishTile_072.png'),
                "Negative_Cat": load_image('assets/images/characters/enemy/zombie_cat.png')
                }
...
class Hurt_Cat(pygame.sprite.Sprite):
    def __init__(self, x, y, image):
        super().__init__()
...
class Level():
    ...
    def load_items(self):
        ...
        for element in self.map_data['items']:
            ...
            if kind == "Fish":
                f = Fish(x, y, item_images[kind])
            elif kind == "Cold_Fish":
                f = Fish(x, y, item_images[kind])
            elif kind == "Desert_Fish":
                f = Fish(x, y, item_images[kind])
            elif kind == "Alien_Fish":
                f = Fish(x, y, item_images[kind])
            elif kind == "Negative_Cat":
                f = Hurt_Cat(x,y, item_images[kind])
...
class Game():
    ...
    def show_pause_screen(self):
        text = font_xl.render("PAUSE", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 212
        screen.blit(text, rect)
        
        text = font_sm.render("Press 'P' to unpause", 1, WHITE)
        rect = text.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect.centery = 272
        screen.blit(text, rect)
    ...
    def show_title_screen(self):
        ...
        screen.blit(start_image,[100,0])
        screen.blit(idle,[1000,100])
        screen.blit(idle_dog1,[1000,200])
        screen.blit(idle_dog2,[1000,300])
    ...
    def show_win_screen(self):
        ...
        text2 = font_md.render("Press 'SPACE' to play again!",1,WHITE)
        rect = text.get_rect()
    ...
    def show_lose_screen(self):
        ...
        text2 = font_md.render("Press 'space' to continue", 1 , WHITE)
        rect = text.get_rect()
        rect2 = text2.get_rect()
        rect.centerx = SCREEN_WIDTH // 2
        rect2.centerx = SCREEN_WIDTH //2 
    ...
    def show_stats(self):
        ...
        score_str = "L: " + str(self.hero.lives)
    ...
    def display_high_score(self, high_score):
        ...
        high_score_rect.right = SCREEN_WIDTH // 2 - 80
        high_score_rect.top = SCREEN_HEIGHT // 2 + 120
        high_text = font_lg.render ("High Score",1,WHITE)
        player_score = font_lg.render (str(self.hero.score),1,WHITE)
        player_score_rect = player_score.get_rect()
        player_score_rect.right = SCREEN_WIDTH // 2 - 80
        player_score_rect.top = SCREEN_HEIGHT // 2 + 120

        screen.blit (high_text, [SCREEN_WIDTH // 2 - 60, SCREEN_HEIGHT // 2 + 120 ])
        if int(high_score) > self.hero.score:
    ...
    def write_score(self, high_score):
        if int(high_score) > self.hero.score:
            pass
        elif int(high_score) < self.hero.score:
            with open ("score_file.txt", "w") as f:
                f.write (str(self.hero.score))
                
    def congratulations(self, high_score):
        if int(high_score) < self.hero.score:
            congrats_text = font_lg.render ("Congratulations you have a NEW high score!!",1,WHITE)
            congrats_text_rect = congrats_text.get_rect()
            congrats_text_rect.right = SCREEN_WIDTH //2 + 450
            congrats_text_rect.top = SCREEN_HEIGHT //2 
    ...
    def render(self):
        ...
        if self.stage == Game.START:
            ...
            self.congratulations(high_score)
